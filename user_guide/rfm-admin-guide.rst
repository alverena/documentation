...
For information about what is RFM and how to use it in OroCRM, please see the `RFM Analysis <./rfm-user-guide>`__ guide.
...
4. If required, modify the ranking table as described in the `Modify the Ranking Table <./rfm-admin-guide.html#modify-the-ranking-table>`__ section of this guide.
...
.. note::
    ...
    For information about how to define segments, see the `How the RFM Analysis Is Done <./rfm-user-guide.html#how-the-rfm-analysis-is-done>`__ section of the `RFM Analysis <./rfm-user-guide>`__ guide.
...
3. Follow steps 2–5 of the `Configure RFM While Creating a New Channel <./rfm-admin-guide.html#configure-rfm-segments-while-creating-a-new-channel>`__ section.
