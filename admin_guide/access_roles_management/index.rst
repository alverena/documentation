...
-  Roles assigned to the user: 
   ...
   Users can check which roles are assigned to them on the **My User** page (see `Access You User Page <./intro-log-in-and-edit-profile#access-your-user-page>`__ section). 
